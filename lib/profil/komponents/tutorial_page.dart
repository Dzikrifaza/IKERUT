...
import 'package:ikerut/login_page.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                'Buka aplikasi IKERUT yang telah dipasang pada gadget anda.',
                style: TextStyle(
                    color: Colors.black54,
                    // fontWeight: FontWeight.w500,
                    fontSize: 17.0),
            ...
            Container(
              ...
              padding: const EdgeInsets.only(left: 53, right: 15),
              child: Text(
                'Pada tutorial ini pengguna melihat panduan penggunaan aplikasi IKERUT.',
                style: TextStyle(
                    color: Colors.black54,
                    // fontWeight: FontWeight.w500,
                    fontSize: 17.0),
            ...
            Container(
              ...
              child: Text(
                'Tombol logout ini digunakan untuk mengeluarkan akun dari aplikasi IKERUT.',
                style: TextStyle(
                    color: Colors.black54,
                    // fontWeight: FontWeight.w500,
                    fontSize: 17.0),
