                ...
                <div class="col-lg-5">
                    ...
                    <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                        ...
                        <div class="card-header border-0 bg-danger py-5">
                            ...
                            <div class="text-white">Ikerut aplikasi isi ulang kebutuhan rumah tangga yang menyediakan
                                beberapa produk - produk Refill</div>
                            <div class="text-white">Pemesanan produk yang mudah hanya menggunakan gadget dan tinggal
                                menunggu pesanan anda datang ke lokasi.</div>
                            <div class="text-white">Lebih ramah lingkungan, tidak menggunakan kemasan plastik hanya
                                dengan mengisi ulang kembali botol anda </div>
                            ...
                            <div class="card-spacer mt-n25">
                                ...
                                <div class="row m-0">
                                    <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                        ...
                                        <a href="#" class="text-warning font-weight-bold font-size-h6">Data
                                            Produk</a>
                                    </div>
                                    <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                                        ...
                                        <a href="#"
                                            class="text-primary font-weight-bold font-size-h6 mt-2"><b>{{ $count_user }}</b>
                                            Data Users</a>
                                    </div>
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="row m-0">
                                    <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                                        ...
                                        <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">Data
                                            Pesanan</a>
                                    </div>
                                    <div class="col bg-light-success px-6 py-8 rounded-xl">
                                        ...
                                        <a href="#" class="text-success font-weight-bold font-size-h6 mt-2">Data
                                            Pengiriman</a>
                                    </div>
                                </div>
                                <!--end::Row-->
                        ...
                        <div class="card-body p-0">
                            <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                                ...
                                <div class="d-flex flex-column text-right">
                                    ...
                                    <span class="text-muted font-weight-bold mt-2">Data Produk</span>
                                </div>
                            </div>
